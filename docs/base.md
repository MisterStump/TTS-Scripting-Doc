...
-- | -- | --:
addNotebookTab(Table parameters) | Returns Int of the index of the newly added notebook tab. | [<span class="i"></span>](#addnotebooktab)
broadcastToAll(String message, Table [color](color)) | Returns Bool with result of printing an on-screen message to all Players. | [<span class="i"></span>](#broadcasttoall)
broadcastToColor(String message,String [player_color](player), Table [color](color)) | Returns Bool with result of printing an on-screen message to a specified Player. | [<span class="i"></span>](#broadcasttocolor)
clearPixelPaint() | Returns Bool with result of removing pixel paint from the instance. | [<span class="i"></span>](#clearpixelpaint)
clearVectorPaint() | Returns Bool with result of removing vector paint from the instance. | [<span class="i"></span>](#clearvectorpaint)
copy(Table object_list) | Returns Bool of result of copying a list of Objects the clipboard. Works with [paste(...)](#paste). | [<span class="i"></span>](#copy)
destroyObject(Object obj) | Returns Bool with the result of destroying an Object. | [<span class="i"></span>](#destroyobject)
editNotebookTab(Table parameters) | Returns Bool with the result of editing an existing Tab in the notebook. | [<span class="i"></span>](#editnotebooktab)
flipTable() | Returns Bool with the result of flipping the table. | [<span class="i"></span>](#fliptable)
getAllObjects() | Returns Table of all spawned [Objects](object) in the game. | [<span class="i"></span>](#getallobjects)
getNotebookTabs() | Returns Table of all tabs in the notebook. | [<span class="i"></span>](#getnotebooktabs)
getNotes() | Returns String of the contents of the on-screen notes section. | [<span class="i"></span>](#getnotes)
getObjectFromGUID(String guid) | Returns Object from GUID. Will return `nil` if it doesn't exist in-game. | [<span class="i"></span>](#getobjectfromguid)
getSeatedPlayers() | Returns Table of the colors of seated players. | [<span class="i"></span>](#getseatedplayers)
log(Var element, String tag, String label) | Returns Bool with result of printing information to the log. (Shortcut: ~)  | [<span class="i"></span>](#log)
logStyle(String tag, Table color, String prefix, String prefix, String postfix) | Returns bool with result of setting style options for the specified tag type for the log. | [<span class="i"></span>](#logstyle)
paste(Table parameters) | Returns Table of newly spawned objects that were pasted from the clipboard. Works with [copy(...)](#copy). | [<span class="i"></span>](#paste)
print(String message) | Prints a string into chat that only the host is able to see. Used for debugging scripts. | [<span class="i"></span>](#print)
printToAll(String message, Table [color](#color)) | Returns Bool with the result of printing a message into the chat of all connected players. | [<span class="i"></span>](#printtoall)
printToColor(String message,String [player_color](#color), Table [color](#color)) | Returns Bool with the result of printing a message to a specific Player. | [<span class="i"></span>](#printtocolor)
removeNotebookTab(Int index) | Returns Bool with the result of removing a notebook tab. | [<span class="i"></span>](#removenotebooktab)
sendExternalMessage(Table) | Returns Bool with the result of sending the table to your external script editor, most likely Atom. This is for custom editor functionality. | [<span class="i"></span>](#sendexternalmessage)
setNotes(String notes) | Returns Bool with the result of replacing the text in the notes window with the string. | [<span class="i"></span>](#setnotes)
spawnObject(Table parameters) | Returns Object reference for the object spawned. View the [Spawnable Object](spawnableobject) page for Objects that can be spawned. | [<span class="i"></span>](#spawnobject)
startLuaCoroutine(Object function_owner,String function_name) | Returns Bool with the result of starting a coroutine. | [<span class="i"></span>](#startluacoroutine)
stringColorToRGB(String player_color) | Returns Table [Color](color) requivilent to the Player Color string. | [<span class="i"></span>](#stringcolortorgb)
